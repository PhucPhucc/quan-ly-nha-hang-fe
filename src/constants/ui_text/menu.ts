export const MENU = {
  ...
  RECIPE: {
    SETUP_TITLE: "Thiết lập công thức",
    SETUP_DESC: "Xác định thành phần và số lượng cần thiết cho món này trong menu.",
    ADD_INGREDIENT: "Thêm thành phần",
    TOTAL_COST: "Tổng chi phí công thức",
    ...
    INGREDIENTS_LIST: "Danh sách thành phần",
    EMPTY_MAPPED: "Không có thành phần nào được ánh xạ. Nhấp vào Thêm thành phần.",
    CURRENCY: "$",
    DISCARD: "Hủy bỏ",
    LƯU: "Đang lưu...",
