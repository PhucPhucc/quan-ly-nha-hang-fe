export const SETTINGS = {
  ...
  FIELD_LEGAL_BUSINESS_NAME_PLACEHOLDER: "VD: CÔNG TY TNHH FOODHUB",
  FIELD_BRAND_NAME: "Tên thương hiệu",
  FIELD_BRAND_NAME_PLACEHOLDER: "VD: FoodHub Premium",
  FIELD_TAX_CODE: "Mã số thuế (MST)",
  FIELD_TAX_CODE_PLACEHOLDER: "VD: 0123456789",
  ERR_TAX_CODE_FORMAT: "Mã số thuế phải bao gồm 10 hoặc 13 chữ số",
  FIELD_BUSINESS_REG_NUMBER: "Số ĐKKD",
  FIELD_BUSINESS_REG_NUMBER_PLACEHOLDER: "VD: 0123456789",
  FIELD_BRANCH_CODE: "Mã chi nhánh",
  FIELD_BRANCH_CODE_PLACEHOLDER: "VD: CN01",
  FIELD_RESTAURANT_CODE: "Mã nhà hàng (Unique)",
  FIELD_RESTAURANT_CODE_PLACEHOLDER: "VD: FOODHUB_01",
  ERR_RESTAURANT_CODE_REQUIRED: "Mã nhà hàng không được để trống",
  ERR_RESTAURANT_CODE_FORMAT: "Chỉ chứa chữ, số, dấu gạch dưới (tối đa 50 ký tự)",
  ...
  FIELD_HOTLINE_PLACEHOLDER: "VD: 0987654321",
  FIELD_EMAIL: "Email",
  FIELD_EMAIL_PLACEHOLDER: "VD: contact@foodhub.vn",
  FIELD_WEBSITE: "Website",
  FIELD_WEBSITE_PLACEHOLDER: "VD: https://foodhub.vn",
  FIELD_FACEBOOK: "Facebook",
  FIELD_FACEBOOK_PLACEHOLDER: "VD: https://facebook.com/foodhub",
  FIELD_ZALO_OA: "Zalo OA",
  FIELD_ZALO_OA_PLACEHOLDER: "VD: https://zalo.me/123456789",
  FIELD_INSTAGRAM: "Instagram",
  FIELD_INSTAGRAM_PLACEHOLDER: "VD: https://instagram.com/foodhub",
  ERR_PHONE_FORMAT: "Định dạng số điện thoại Việt Nam (10 số, bắt đầu 0, 84, +84)",
  ERR_EMAIL_FORMAT: "Định dạng Email hợp lệ",
  ERR_URL_FORMAT: "Link URL hợp lệ",

  // Address
  ADDRESS_SECTION: "Địa chỉ chi tiết",
  ADDRESS_SECTION_DESC: "Địa chỉ cụ thể của nhà hàng",
  FIELD_COUNTRY: "Quốc gia",
  FIELD_COUNTRY_PLACEHOLDER: "VD: Vietnam",
  FIELD_PROVINCE_CITY: "Tỉnh / Thành phố",
  FIELD_PROVINCE_CITY_PLACEHOLDER: "VD: TP. Hồ Chí Minh",
  FIELD_DISTRICT: "Quận / Huyện",
  FIELD_DISTRICT_PLACEHOLDER: "VD: Quận 1",
  FIELD_WARD: "Phường / Xã",
  FIELD_WARD_PLACEHOLDER: "VD: Phường Bến Nghé",
  FIELD_STREET_ADDRESS: "Tên đường, số nhà",
  FIELD_STREET_ADDRESS_PLACEHOLDER: "VD: 123 Đường Lê Lợi",
  FIELD_POSTAL_CODE: "Mã bưu chính",
  FIELD_POSTAL_CODE_PLACEHOLDER: "VD: 700000",
  ERR_POSTAL_CODE_FORMAT: "Mã bưu điện chỉ được chứa các chữ số",
  FIELD_GOOGLE_MAP_URL: "Google Map URL",
  FIELD_GOOGLE_MAP_URL_PLACEHOLDER: "VD: https://goo.gl/maps/123",
  ERR_GOOGLE_MAP_URL_FORMAT: "Link URL hợp lệ",
  ...
  ERR_VAT_FORMAT: "VAT phải nằm trong khoảng từ 0 đến 100",
  ...
  FIELD_TIME_FORMAT_24H: "24 Hours (e.g. 14:00)",
  FIELD_TIME_FORMAT_12H: "12 Hours (e.g. 02:00 PM)",
  FIELD_OPENING_TIME: "Opening Time",
  FIELD_CLOSING_TIME: "Closing Time",
  ERR_CLOSING_TIME_MUST_BE_AFTER_OPENING: "Closing time must be after opening time",
  FIELD_WORKING_DAYS: "Working Days",
