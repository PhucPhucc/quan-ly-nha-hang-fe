export const ORDER = {
  ...
  CURRENT: {
    ...
    CARD: "Thẻ (POS)",
    MIXED_CASH_QR: "Tiền mặt + QR",
    CUSTOMER_GAVE: "Khách đưa",
    QR_AMOUNT: "QR thanh toán",
    CHANGE: "Tiền thối lại",
    PROCESSING: "Đang xử lý...",
    CREATING_QR: "Đang tạo QR...",
    CREATE_QR_WITH_AMOUNT: (amount: string) => `Tạo QR thanh toán (${amount})`,
    SUBTOTAL: "Tạm tính",
    TAX: "Thuế (VAT 10%)",
    DISCOUNT: "Giảm giá",
    ...
    SYNC_PAYMENT: "Kiểm tra thanh toán",
    SYNCING: "Đang kiểm tra...",
    SYNC_CONFIRM: "Hệ thống sẽ kiểm tra trạng thái thanh toán từ PayOS.",
  },
  PRINT_TEMP: {
    ...
    PAYMENT_METHOD_LABEL: "Hình thức:",
    CUSTOMER_GAVE_LABEL: "Tiền khách đưa:",
    CHANGE_LABEL: "Tiền trả lại:",
    METHOD_TRANSFER_QR: "Chuyển khoản / QR",
    METHOD_CASH: "Tiền mặt",
    METHOD_CARD: "Thẻ / Chuyển khoản",
    SHOP_ADDRESS: "123 Đường Ẩm Thực, Quận 1, HCM",
    SHOP_PHONE_PREFIX: "ĐT:",
    SHOP_PHONE: "0123.456.789",
    RECEIPT_ID_PREFIX: "Số:",
    PRINT_DATE: "Ngày in:",
    TABLE_PREFIX: "Bàn:",
    TAKEAWAY_LABEL: "Mang về",
    CASHIER_LABEL: "Thu ngân:",
    ITEM_NAME_HEADER: "Tên món",
    QUANTITY_HEADER: "SL",
    AMOUNT_HEADER: "Thành tiền",
    SUBTOTAL_LABEL: "Tiền hàng:",
