      ...
      <CardHeader className="border-b">
        <div className="flex items-center justify-between gap-6 mb-2.5">
          <span className="text-sm font-medium text-muted-foreground">
            {area.name} {UI_TEXT.COMMON.DASH} <strong>{tables.length} </strong>{" "}
            {UI_TEXT.TABLE.TABLES} {UI_TEXT.COMMON.BULLET} {totalSeats} {UI_TEXT.TABLE.SEATS}{" "}
            {UI_TEXT.COMMON.BULLET} <strong>{activeCount}</strong> {UI_TEXT.TABLE.AVAILABLE_COUNT}{" "}
            {UI_TEXT.COMMON.BULLET} <strong>{inactiveCount}</strong> {UI_TEXT.TABLE.INACTIVE_COUNT}
          </span>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between rounded-t-lg border-b border-gray-100 bg-gray-50 px-4 py-3">
        <h3 className="text-sm font-bold uppercase">{UI_TEXT.TABLE.EDIT_TABLE(table.tableCode)}</h3>
      ...
      <div className="space-y-4 p-4">
        ...
        <div className="space-y-1">
          <label className="text-[10px] font-bold uppercase tracking-wider text-gray-500">
            {UI_TEXT.TABLE.SEAT_COUNT_LABEL}
          </label>
