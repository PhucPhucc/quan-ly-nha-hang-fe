    ...
    <div className="absolute left-full top-1/2 z-50 ml-4 w-64 -translate-y-1/2 rounded-lg border border-slate-200 bg-white p-4 shadow-xl">
      ...
      <div className="relative z-10">
        <div className="mb-2 flex items-start justify-between">
          <h4 className="font-bold text-slate-900">{UI_TEXT.TABLE.TABLE_LABEL(table.tableCode)}</h4>
        ...
        <p className="mb-4 text-xs text-slate-500">
          {UI_TEXT.TABLE.RECT_SHAPE} {UI_TEXT.COMMON.BULLET} {table.capacity}{" "}
