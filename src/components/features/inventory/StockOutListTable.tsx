...
const STOCK_OUT_ITEMS_COUNT = "Số NVL xuất";
      ...
      <Table>
        <TableHeader>
          <TableRow variant="header">
            ...
            <TableHead>{STOCK_OUT_ITEMS_COUNT}</TableHead>
            ...
            <>
              {data.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>{formatDate(item.stockOutDate)}</TableCell>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="rounded-lg p-1.5 shadow-xl border-border/40 min-w-[160px]"
                      >
                        ...
                        {onDelete && (
                          <DropdownMenuItem onClick={() => onDelete(item.id)}>
                            <Trash2 className="size-4" /> {UI_TEXT.BUTTON.DELETE}
                          </DropdownMenuItem>
                        )}
                      </DropdownMenuContent>
                    </DropdownMenu>
