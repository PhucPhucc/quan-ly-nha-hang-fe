    ...
    <TableShell>
      <Table>
        <TableHeader className="bg-muted/50">
          <TableRow>
            <TableHead className="font-bold p-3">{UI_TEXT.MENU.OPTIONS.NAME_GROUP}</TableHead>
            <TableHead className="font-bold p-3 w-[130px]">{UI_TEXT.MENU.OPTIONS.TYPE}</TableHead>
            <TableHead className="font-bold p-3">{UI_TEXT.MENU.OPTIONS.COMBO_ITEMS}</TableHead>
            <TableHead className="font-bold p-3 w-[110px]">{UI_TEXT.COMMON.CREATE_AT}</TableHead>
            <TableHead className="font-bold p-3 w-[110px]">{UI_TEXT.COMMON.UPDATE_AT}</TableHead>
            <TableHead className="font-bold p-3 text-center w-[120px]">
