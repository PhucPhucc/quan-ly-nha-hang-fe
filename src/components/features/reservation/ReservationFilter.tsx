    ...
    <div className="flex flex-col gap-4 mb-6">
      <div className="flex flex-col lg:flex-row gap-4 items-center justify-between bg-background p-3 rounded-2xl border">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="w-44">
              <div className="relative">
                <CalendarIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-card-foreground pointer-events-none" />
                <Input
                  type="date"
                  value={date}
                  onChange={(e) => onDateChange(e.target.value)}
                  className="pl-10 bg-card border text-[13px] rounded-lg text-card-foreground focus-visible:ring-primary/20 shadow-sm transition-all cursor-pointer"
                />
              </div>
            </div>
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className="p-2 shrink-0 rounded-full bg-card text-card-foreground hover:text-primary hover:border-primary/20 transition-all shadow-sm"
        ...
        <div className="flex items-center gap-3">
          <Button
            className="shrink-0 rounded-lg bg-primary hover:bg-primary/90 text-white font-bold px-8 shadow-lg shadow-primary/20 transition-all active:scale-95"
